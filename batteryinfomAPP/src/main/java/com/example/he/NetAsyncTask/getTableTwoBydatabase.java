 ...
 */
public class getTableTwoBydatabase extends AsyncTask<Object, Object, String>{
    // WSDL文档中的命名空间
    ...
    public getTableTwoBydatabase(Context context, String Expid, String id, ListView titleListview, ListView listView, Handler handler){
        mcontext = context;
        mExpid = Expid;
        mid = id;
